...
def get_args():
    ...
    parser.add_argument("--pooling_norm", action="store_true", default=False)
    parser.add_argument("--ff_layernorm", action="store_true", default=False)
    ...
    parser.add_argument("--optimizer", type=str, default="adagrad", choices=["adagrad", "adam", "adamw"])
    parser.add_argument("--weight_decay", type=float, default=0.0)
    parser.add_argument("--scheduler", type=str, default="none", choices=["none", "plateau", "step", "cosine"])
...
def main():
    ...
    if args.scheduler == "plateau":
        ...
        scheduler = torch.optim.lr_scheduler.CosineAnnealingLR(
            optimizer, T_max=max(total_steps, 1), eta_min=args.min_lr
        )
